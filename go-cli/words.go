...
func registerSDKWords(r *eng.Registry, client *sdk.AirtableSDK) {
...
func runOp(client *sdk.AirtableSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
