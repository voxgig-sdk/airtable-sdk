...
from airtable_sdk.core.control import AirtableControl
...
from airtable_sdk.core.helpers import get_ctx_prop, to_map
...
class AirtableContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, AirtableResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, AirtableResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AirtableError(code, msg, self)
