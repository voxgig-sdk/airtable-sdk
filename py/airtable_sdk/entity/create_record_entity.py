...
from airtable_sdk.airtable_types import (
    CreateRecord,
...
class CreateRecordEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CreateRecordEntity(self._client, opts)
    ...
    def data_get(self) -> CreateRecord:
    ...
    def match_get(self) -> CreateRecord:
    ...
    def create(self, reqdata: CreateRecordCreateData, ctrl=None) -> CreateRecord:
        utility = self._utility
