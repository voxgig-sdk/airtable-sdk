# Airtable SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AirtableSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AirtableSDK(...) and AirtableSDK.test(...) become
#      AirtableSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "airtable_sdk"
_SDK_CLASS = "AirtableSDK"
