...
// Airtable SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AirtableTestFeature extends AirtableBaseFeature
{
    ...
    public function init(AirtableContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AirtableContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AirtableContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AirtableContext $ctx, $op, $args): array
    {
