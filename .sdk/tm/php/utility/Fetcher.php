...
class AirtableFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AirtableSDK/1.0)';
    ...
    public static function call(AirtableContext $ctx, string $fullurl, array $fetchdef): array
    {
