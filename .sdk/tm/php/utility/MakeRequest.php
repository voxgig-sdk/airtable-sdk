...
// Airtable SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AirtableMakeRequest
{
    public static function call(AirtableContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AirtableResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AirtableResponse($fetched);
        } else {
