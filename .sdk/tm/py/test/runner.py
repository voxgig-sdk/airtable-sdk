...
class AirtableTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AirtableTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AirtableTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AirtableTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
