...
function envOverride(m) {
    if ('TRUE' === process.env.AIRTABLE_TEST_LIVE ||
        'TRUE' === process.env.AIRTABLE_TEST_OVERRIDE) {
    ...
    m.AIRTABLE_TEST_EXPLAIN = process.env.AIRTABLE_TEST_EXPLAIN || m.AIRTABLE_TEST_EXPLAIN;
    return m;
}
