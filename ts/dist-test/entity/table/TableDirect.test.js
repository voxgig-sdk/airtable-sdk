...
(0, node_test_1.describe)('TableDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-table', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-table', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["base01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AIRTABLE_TEST_TABLE_ENTID'];
...
//# sourceMappingURL=TableDirect.test.js.map