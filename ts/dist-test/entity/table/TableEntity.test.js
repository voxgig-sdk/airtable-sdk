...
(0, node_test_1.describe)('TableEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'table.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != table_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(table_ref01_list, { id: table_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/table/TableTestData.json');
    ...
    let idmap = transform(['table01', 'table02', 'table03', 'base01', 'base02', 'base03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['AIRTABLE_TEST_TABLE_ENTID'];
...
//# sourceMappingURL=TableEntity.test.js.map