...
(0, node_test_1.describe)('RecordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-record', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-record', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["base01", "record01", "table01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.base_id ?? listArr[0]?.id;
            if (null == candidateId) {
                return; // skip: list response shape does not expose load identifier
            }
            params.base_id = candidateId;
            params.base_id = setup.idmap['base01'];
            params.record_id = setup.idmap['record01'];
    ...
    (0, node_test_1.test)('direct-list-record', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-record', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["base01", "table01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
