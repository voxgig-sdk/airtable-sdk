...
(0, node_test_1.describe)('BaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-base', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-base', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['AIRTABLE_TEST_BASE_ENTID'];
...
//# sourceMappingURL=BaseDirect.test.js.map