...
class AirtableTestRunner
{
    ...
    {
        $live = self::getenv('AIRTABLE_TEST_LIVE');
        $override = self::getenv('AIRTABLE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AIRTABLE_TEST_EXPLAIN');
...
class_alias('AirtableTestRunner', 'Runner');
class_alias('AirtableHelpers', 'Helpers');
