...
// Airtable SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AirtableSDK::test)
...
{
    private const SDK_CLASS = 'AirtableSDK';
    ...
    private const SDK_BASE = 'airtable_sdk';
