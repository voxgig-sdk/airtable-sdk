...
class GetRecordEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetRecordEntity($this->_client, $opts);
    }

    /**
     * @param GetRecord|array $args GetRecord data (assoc-array) to store.
     */
    ...
    /**
     * @return GetRecord|array The current GetRecord data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetRecord fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetRecord fields).
     */
    ...
    /**
     * Load a single GetRecord.
     *
     * @param GetRecordLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetRecordLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetRecord|array The loaded GetRecord as an assoc-array at the
