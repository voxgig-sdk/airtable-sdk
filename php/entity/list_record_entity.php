...
// Airtable SDK ListRecord entity
...
class ListRecordEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListRecordEntity($this->_client, $opts);
    }

    /**
     * @param ListRecord|array $args ListRecord data (assoc-array) to store.
     */
    ...
    /**
     * @return ListRecord|array The current ListRecord data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListRecord fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListRecord fields).
     */
    ...
    /**
     * List ListRecord items matching the given filter.
     *
     * @param ListRecordListMatch|array|null $reqmatch Match filter (any subset
     *   of ListRecord fields) as an assoc-array; ListRecordListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListRecord[]|array A list of ListRecord items as assoc-arrays at
     *   the SDK boundary; throws AirtableError on failure (item-5 convention).
     */
