...
class TableEntity
{
    ...
    /**
     * List Table items matching the given filter.
     *
     * @param TableListMatch|array|null $reqmatch Match filter (any subset
     *   of Table fields) as an assoc-array; TableListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Table[]|array A list of Table items as assoc-arrays at
     ...
     * Create a new Table.
     *
     * @param TableCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TableCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Table|array The created Table as an assoc-array at the
