...
class BaseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BaseEntity($this->_client, $opts);
    }

    /**
     * @param Base|array $args Base data (assoc-array) to store.
     */
    ...
    /**
     * @return Base|array The current Base data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Base fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Base fields).
     */
    ...
    /**
     * List Base items matching the given filter.
     *
     * @param BaseListMatch|array|null $reqmatch Match filter (any subset
     *   of Base fields) as an assoc-array; BaseListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Base[]|array A list of Base items as assoc-arrays at
