...
local ListRecordEntity = {}
ListRecordEntity.__index = ListRecordEntity


function ListRecordEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListRecordEntity)
  self._name = "list_record"
  self._client = client
...
function ListRecordEntity:get_name()
  return self._name
end


function ListRecordEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListRecordEntity.new(self._client, opts)
end
...
function ListRecordEntity:mark_deleted()
  self._deleted = true
end


function ListRecordEntity:deleted()
  return true == self._deleted
end


function ListRecordEntity:data_set(args)
  if args ~= nil then
...
function ListRecordEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListRecordEntity:match_set(args)
  if args ~= nil then
...
function ListRecordEntity:match_get()
...
function ListRecordEntity:stream(action, args, callopts)
...
---@param reqmatch ListRecordListMatch
---@param ctrl? table
---@return ListRecord[]
---@return string? err
function ListRecordEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ListRecordEntity:_run_op(ctx, post_done)
  local utility = self._utility
