...
describe("BaseDirect", function()
  it("should direct-list-base", function()
    local setup = base_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-base", setup.live and "live" or "unit")
