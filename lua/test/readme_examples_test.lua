...
-- data to return.
local TEST_SEED = '{ entity = { ["base"] = { ["test01"] = { id = "test01" } }, ["create_record"] = { ["test01"] = { id = "test01" } }, ["get_record"] = { ["test01"] = { id = "test01" } }, ["list_record"] = { ["test01"] = { id = "test01" } }, ["table"] = { ["test01"] = { id = "test01" } } } }'
