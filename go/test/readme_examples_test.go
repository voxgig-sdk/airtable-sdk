...
const testSeed = `map[string]any{"entity": map[string]any{"base": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "create_record": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_record": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_record": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "table": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
