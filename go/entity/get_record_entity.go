...
func NewGetRecordEntity(client *core.AirtableSDK, entopts map[string]any) *GetRecordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetRecordEntity) GetName() string { return e.name }
...
func (e *GetRecordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetRecordEntity) Deleted() bool {
	return e.deleted
}


func (e *GetRecordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetRecordEntity(e.client, opts)
}

func (e *GetRecordEntity) Data(args ...any) any {
...
func (e *GetRecordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetRecord; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetRecordEntity) DataTyped(data ...GetRecord) GetRecord {
	if len(data) > 0 {
		return typedFrom[GetRecord](e.Data(asMap(data[0])))
	}
	return typedFrom[GetRecord](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetRecord (all fields
// optional at the wire level).
func (e *GetRecordEntity) MatchTyped(match ...GetRecord) GetRecord {
	if len(match) > 0 {
		return typedFrom[GetRecord](e.Match(asMap(match[0])))
	}
	return typedFrom[GetRecord](e.Match())
}
...
func (e *GetRecordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetRecordEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetRecordLoadMatch and returns an GetRecord. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetRecordEntity) LoadTyped(reqmatch GetRecordLoadMatch, ctrl map[string]any) (GetRecord, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetRecord{}, err
	}
	return typedFrom[GetRecord](res), nil
}



func (e *GetRecordEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetRecordEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetRecordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetRecordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetRecordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
