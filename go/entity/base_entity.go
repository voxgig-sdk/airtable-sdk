...
func NewBaseEntity(client *core.AirtableSDK, entopts map[string]any) *BaseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BaseEntity) Deleted() bool {
	return e.deleted
}


func (e *BaseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBaseEntity(e.client, opts)
}

func (e *BaseEntity) Data(args ...any) any {
...
func (e *BaseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Base; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BaseEntity) DataTyped(data ...Base) Base {
	if len(data) > 0 {
		return typedFrom[Base](e.Data(asMap(data[0])))
	}
	return typedFrom[Base](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Base (all fields
// optional at the wire level).
func (e *BaseEntity) MatchTyped(match ...Base) Base {
	if len(match) > 0 {
		return typedFrom[Base](e.Match(asMap(match[0])))
	}
	return typedFrom[Base](e.Match())
}
...
func (e *BaseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BaseEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BaseEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BaseListMatch and returns []Base. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BaseEntity) ListTyped(reqmatch BaseListMatch, ctrl map[string]any) ([]Base, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Base](res), nil
}



func (e *BaseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BaseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BaseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BaseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
