...
type CreateRecordEntity struct {
	name    string
	client  *core.AirtableSDK
...
func NewCreateRecordEntity(client *core.AirtableSDK, entopts map[string]any) *CreateRecordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreateRecordEntity) GetName() string { return e.name }
...
func (e *CreateRecordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreateRecordEntity) Deleted() bool {
	return e.deleted
}


func (e *CreateRecordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreateRecordEntity(e.client, opts)
}

func (e *CreateRecordEntity) Data(args ...any) any {
...
func (e *CreateRecordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CreateRecord; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreateRecordEntity) DataTyped(data ...CreateRecord) CreateRecord {
	if len(data) > 0 {
		return typedFrom[CreateRecord](e.Data(asMap(data[0])))
	}
	return typedFrom[CreateRecord](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CreateRecord (all fields
// optional at the wire level).
func (e *CreateRecordEntity) MatchTyped(match ...CreateRecord) CreateRecord {
	if len(match) > 0 {
		return typedFrom[CreateRecord](e.Match(asMap(match[0])))
	}
	return typedFrom[CreateRecord](e.Match())
}
...
func (e *CreateRecordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreateRecordEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CreateRecordEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CreateRecordEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreateRecordCreateData and returns an CreateRecord. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CreateRecordEntity) CreateTyped(reqdata CreateRecordCreateData, ctrl map[string]any) (CreateRecord, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CreateRecord{}, err
	}
	return typedFrom[CreateRecord](res), nil
}



func (e *CreateRecordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreateRecordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreateRecordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
