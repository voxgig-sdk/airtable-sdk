...
func NewListRecordEntity(client *core.AirtableSDK, entopts map[string]any) *ListRecordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListRecordEntity) GetName() string { return e.name }
...
func (e *ListRecordEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListRecordEntity) Deleted() bool {
	return e.deleted
}


func (e *ListRecordEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListRecordEntity(e.client, opts)
}

func (e *ListRecordEntity) Data(args ...any) any {
...
func (e *ListRecordEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListRecord; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListRecordEntity) DataTyped(data ...ListRecord) ListRecord {
	if len(data) > 0 {
		return typedFrom[ListRecord](e.Data(asMap(data[0])))
	}
	return typedFrom[ListRecord](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListRecord (all fields
// optional at the wire level).
func (e *ListRecordEntity) MatchTyped(match ...ListRecord) ListRecord {
	if len(match) > 0 {
		return typedFrom[ListRecord](e.Match(asMap(match[0])))
	}
	return typedFrom[ListRecord](e.Match())
}
...
func (e *ListRecordEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListRecordEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ListRecordEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListRecordListMatch and returns []ListRecord. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ListRecordEntity) ListTyped(reqmatch ListRecordListMatch, ctrl map[string]any) ([]ListRecord, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ListRecord](res), nil
}



func (e *ListRecordEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListRecordEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListRecordEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListRecordEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
