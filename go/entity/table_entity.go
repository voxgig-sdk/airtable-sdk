...
func NewTableEntity(client *core.AirtableSDK, entopts map[string]any) *TableEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TableEntity) GetName() string { return e.name }
...
func (e *TableEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TableEntity) Deleted() bool {
	return e.deleted
}


func (e *TableEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTableEntity(e.client, opts)
}

func (e *TableEntity) Data(args ...any) any {
...
func (e *TableEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Table; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TableEntity) DataTyped(data ...Table) Table {
	if len(data) > 0 {
		return typedFrom[Table](e.Data(asMap(data[0])))
	}
	return typedFrom[Table](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Table (all fields
// optional at the wire level).
func (e *TableEntity) MatchTyped(match ...Table) Table {
	if len(match) > 0 {
		return typedFrom[Table](e.Match(asMap(match[0])))
	}
	return typedFrom[Table](e.Match())
}
...
func (e *TableEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TableEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TableEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TableListMatch and returns []Table. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TableEntity) ListTyped(reqmatch TableListMatch, ctrl map[string]any) ([]Table, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Table](res), nil
}




func (e *TableEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TableCreateData and returns an Table. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TableEntity) CreateTyped(reqdata TableCreateData, ctrl map[string]any) (Table, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Table{}, err
	}
	return typedFrom[Table](res), nil
}



func (e *TableEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TableEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TableEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
